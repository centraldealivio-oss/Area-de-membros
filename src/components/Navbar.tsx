...
import { ShieldCheck, Lock, Sparkles, LogOut, Terminal, Server, ExternalLink, Flame } from 'lucide-react';
...
interface NavbarProps {
  ...
  onLogout: () => void;
  activeTab: 'curso' | 'bonuses';
  setActiveTab: (tab: 'curso' | 'bonuses') => void;
}
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#121214]/90 backdrop-blur-md border-b border-white/5 text-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex md:hidden space-x-2 py-2 border-t border-white/5">
          <button
            onClick={() => setActiveTab('curso')}
          ...
          <button
            onClick={() => setActiveTab('bonuses')}
            className={`flex-1 py-2 rounded-xl text-xs font-semibold text-center flex items-center justify-center space-x-1 ${
              activeTab === 'bonuses'
